...
public class NFCMainActivity extends AppCompatActivity implements Listener {
    ...
    private void initViews() {
        ...
        mEtMessage = (Button) findViewById(R.id.et_message);
        mBtWrite = (Button) findViewById(R.id.btn_write);
        mBtRead = (Button) findViewById(R.id.btn_read);
        gotohistoryButton = (Button) findViewById(R.id.gotohistoryButton);
        mypage = (Button)findViewById(R.id.mypage);

        mBtWrite.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), BalanceCharge.class);
        ...
        mEtMessage.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        gotohistoryButton.setOnClickListener(new Button.OnClickListener() {
            @Override
           public void onClick(View view) {
